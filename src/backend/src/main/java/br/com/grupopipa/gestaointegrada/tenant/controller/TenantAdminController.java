 ...
 *
 * <p>SEGURANÇA: Este endpoint requer um token administrativo secreto O token deve ser configurado
 * em application.properties e mantido em segredo
 *
 * <p>Uso: POST /admin/tenants Header: X-Admin-Token: {seu-token-secreto}
 */
@Slf4j
@RestController
...
public class TenantAdminController {
  ...
  /** Criar novo tenant Requer token administrativo no header X-Admin-Token */
  @PostMapping
  ...
  /** Buscar tenant por ID Requer token administrativo */
  @GetMapping("/{tenantId}")
  ...
  /** Ativar tenant Requer token administrativo */
  ...
  /** Suspender tenant Requer token administrativo */
