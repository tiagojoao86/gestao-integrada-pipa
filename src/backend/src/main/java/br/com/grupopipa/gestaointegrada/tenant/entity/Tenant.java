...
/**
 * Entidade Tenant armazenada no schema public Representa uma
 * empresa/organização que usa o sistema
 */
@Entity
...
public class Tenant {
    ...
    /**
     * Identificador único do tenant (usado no schema name) Exemplo: "empresa_abc",
     * "solar_xyz"
     */
