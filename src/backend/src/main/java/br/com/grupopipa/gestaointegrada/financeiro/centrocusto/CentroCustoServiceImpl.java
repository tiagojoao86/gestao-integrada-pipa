...
public class CentroCustoServiceImpl
    ...
    public CentroCustoServiceImpl(CentroCustoRepository repository,
    ...
    protected CentroCusto mergeEntityAndDTO(CentroCusto entity, CentroCustoDTO dto) {
        ...
        UnidadeNegocio unidadeNegocio = unidadeNegocioRepository.findById(unidadeId)
                .orElseThrow(() -> new EntityNotFoundException("Unidade de Negócio não encontrada", unidadeId));
