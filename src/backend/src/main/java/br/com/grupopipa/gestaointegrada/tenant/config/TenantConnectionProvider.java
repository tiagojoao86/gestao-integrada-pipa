...
/** Provider de conexões para multi-tenancy Altera o search_path do PostgreSQL dinamicamente */
@Slf4j
@Component
public class TenantConnectionProvider implements MultiTenantConnectionProvider<String> {
  ...
  public Connection getConnection(String tenantIdentifier) throws SQLException {
    ...
    try {
      ...
      log.error(
          "Erro ao configurar search_path para tenant [{}]: {}", tenantIdentifier, e.getMessage());
