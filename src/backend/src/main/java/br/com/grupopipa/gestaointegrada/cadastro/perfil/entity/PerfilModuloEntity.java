...
public class PerfilModuloEntity extends BaseEntity {
    ...
    public static class Builder {
        ...
        public PerfilModuloEntity build() {
            return new PerfilModuloEntity(
                    perfil, modulo, podeListar, podeVisualizar, podeEditar, podeDeletar, podeAuditar);
        }
    }

    /*
     * package-private setter to keep both sides consistent when managed by
     * PerfilEntity
     */
