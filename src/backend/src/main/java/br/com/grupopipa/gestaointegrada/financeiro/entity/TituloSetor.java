...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_titulo_setor",
          columnNames = {"titulo_id", "setor_id"})
    })
public class TituloSetor extends BaseEntity {
  ...
  @JoinColumn(
      name = "titulo_id",
      nullable = false,
      foreignKey = @ForeignKey(name = "fk_titulo_setor_titulo"))
  ...
  @JoinColumn(
      name = "setor_id",
      nullable = false,
      foreignKey = @ForeignKey(name = "fk_titulo_setor_setor"))
  private Setor setor;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TituloSetor)) return false;
