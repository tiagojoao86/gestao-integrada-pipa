...
/**
 * Value Object para representar valores monetários Garante precisão de 2 casas decimais e
 * validações
 */
@Embeddable
public class Money implements Serializable {
  ...
  /**
   * Cria um Money garantindo que o valor seja >= 0 Usado para valores que não podem ser negativos:
  ...
  /**
   * Cria um Money garantindo que o valor seja > 0 Usado para valores que devem ser estritamente
   * positivos
   */
