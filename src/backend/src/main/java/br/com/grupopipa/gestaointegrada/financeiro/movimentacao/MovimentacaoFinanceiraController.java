...
public class MovimentacaoFinanceiraController
    extends BaseController<
        MovimentacaoFinanceiraDTO, MovimentacaoFinanceiraGridDTO, MovimentacaoFinanceiraService> {

  private final TituloService tituloService;

  private static final Logger LOGGER =
      LoggerFactory.getLogger(MovimentacaoFinanceiraController.class);

  public MovimentacaoFinanceiraController(
      MovimentacaoFinanceiraService service, TituloService tituloService) {
    super(service);
  ...
  public Response save(@RequestBody MovimentacaoFinanceiraDTO body) {
    if (LOGGER.isInfoEnabled()) {
      try {
        LOGGER.info(
            "Saving MovimentacaoFinanceira - contaBancariaId={}, valor={}, titulosCount={}",
