...
/**
 * Serviço para gerenciar tenants Utiliza Flyway para executar migrations em
...
public class TenantService {
    ...
    /**
     * Cria um novo tenant 1. Salva no banco (schema public) 2. Cria o schema do
     * tenant (FORA da
    ...
    /**
     * Cria o schema no PostgreSQL Usa conexão em AUTOCOMMIT para garantir que o
     * schema seja criado
     * imediatamente
     */
    private void criarSchema(String schemaName) {
        try {
            ...
            String existingSchema = jdbcTemplate
            ...
            String createdSchema = jdbcTemplate
    ...
    /**
     * Executa migrations do Flyway no schema do tenant Usa as mesmas migrations que
     * estão em
     * db/migration/tenant Elimina duplicação: migrations são mantidas apenas em um
     * lugar!
     */
