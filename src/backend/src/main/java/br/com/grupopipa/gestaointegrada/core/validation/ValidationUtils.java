...
public final class ValidationUtils {
    ...
    /**
     * Executa um supplier que cria um Value Object, capturando
     * BeanValidationExceptions. Se uma
     * exceção for capturada, as violações são adicionadas ao conjunto fornecido e o
     * método retorna
