...
/**
 * Implementação customizada para consultas otimizadas de Titulo
 * Usa CriteriaQuery para combinar Specifications com projeção
 */
public class TituloRepositoryImpl implements TituloRepositoryCustom {
    ...
    public Page<TituloProjection> findAllProjected(Specification<Titulo> spec, Pageable pageable) {
        ...
        // Filtrar apenas movimentações não deletadas (deleted = false ou deleted IS NULL)
        Join<Titulo, ?> movimentacoesJoin = root.join("movimentacoes", JoinType.LEFT);

        // Joins para pessoa, categoria e unidade (sem fetch pois estamos usando projeção)
        ...
        // CASE WHEN movimentacao.deleted = false OR movimentacao.deleted IS NULL THEN movimentacao.valor ELSE 0
    ...
    /**
     * Implementação concreta de TituloProjection
     * Classe interna para encapsular os dados retornados pela projeção
     */
    public static class TituloProjectionImpl implements TituloProjection {
        ...
        @Override public br.com.grupopipa.gestaointegrada.financeiro.enums.TipoTitulo getTipo() { return tipo; }
        @Override public br.com.grupopipa.gestaointegrada.financeiro.enums.StatusTitulo getStatus() { return status; }
        @Override public String getNumeroDocumento() { return numeroDocumento; }
        @Override public String getDescricao() { return descricao; }
        @Override public UUID getPessoaId() { return pessoaId; }
        @Override public String getPessoaNome() { return pessoaNome; }
        @Override public UUID getTituloCategoriaId() { return tituloCategoriaId; }
        @Override public String getTituloCategoriaNome() { return tituloCategoriaNome; }
        @Override public UUID getUnidadeNegocioId() { return unidadeNegocioId; }
        @Override public String getUnidadeNegocioCodigo() { return unidadeNegocioCodigo; }
        @Override public String getUnidadeNegocioNome() { return unidadeNegocioNome; }
        @Override public BigDecimal getValorOriginal() { return valorOriginal; }
        @Override public BigDecimal getValorDesconto() { return valorDesconto; }
        @Override public BigDecimal getValorJuros() { return valorJuros; }
        @Override public BigDecimal getValorMulta() { return valorMulta; }
        @Override public BigDecimal getValorPago() { return valorPago; }
        @Override public LocalDate getDataEmissao() { return dataEmissao; }
        @Override public LocalDate getDataVencimento() { return dataVencimento; }
        @Override public LocalDate getDataPagamento() { return dataPagamento; }
        @Override public Integer getNumeroParcela() { return numeroParcela; }
        @Override public Integer getTotalParcelas() { return totalParcelas; }
