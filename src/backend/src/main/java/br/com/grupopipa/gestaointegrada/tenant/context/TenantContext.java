...
/**
 * Contexto para armazenar o tenant atual na thread Usa ThreadLocal para isolar o tenant por
 * requisição
 *
 * <p>IMPORTANTE: Armazena o SCHEMA_NAME (tenant_empresa_solar), não o tenant_id (empresa-solar) O
