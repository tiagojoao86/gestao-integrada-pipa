...
/**
 * Interceptor para identificar e configurar o tenant atual Pode ser identificado por: - Header:
 * X-Tenant-ID - Subdomínio: tenant.gestao-solar.com - Token JWT (claim tenant_id)
 *
 * <p>IMPORTANTE: Requisições sem tenant serão REJEITADAS (exceto rotas públicas)
 */
@Slf4j
@Component
