...
/**
 * Interceptor para identificar e configurar o tenant atual Pode ser
 * identificado por: - Header:
 * X-Tenant-ID - Subdomínio: tenant.gestao-solar.com - Token JWT (claim
 * tenant_id)
 *
 * <p>
...
public class TenantInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // 2. Se não encontrou no header, pode tentar extrair do JWT (implementar
        // depois)
        ...
        log.debug(
                "Tenant identificado: {} (schema: {}) para requisição: {} {}",
                tenantId,
                schemaName,
                request.getMethod(),
                requestPath);
    ...
    private boolean isPublicRoute(String path) {
        ...
        // Rotas de autenticação (login pode ser público ou pode exigir tenant, você
        // decide)
