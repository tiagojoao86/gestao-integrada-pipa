...
/**
 * Entidade Pessoa - modelo flat (sem herança).
 * Contém campos para Pessoa Física e Jurídica, validados por tipo.
 */
@Entity
@Table(name = "pessoa")
public class Pessoa extends BaseEntity {
    ...
    private void validarCamposPorTipo() {
        ...
        if (tipoPessoa == null) {
            ...
            if (cnpj != null) {
                violations.add(new BeanValidationMessage("cnpj", "CNPJ não deve ser informado para Pessoa Física"));
            }
            if (razaoSocial != null) {
                violations.add(new BeanValidationMessage("razaoSocial",
                        "Razão Social não deve ser informada para Pessoa Física"));
            }
            if (inscricaoEstadual != null) {
                violations.add(new BeanValidationMessage("inscricaoEstadual",
            ...
            if (cpf != null) {
                violations.add(new BeanValidationMessage("cpf", "CPF não deve ser informado para Pessoa Jurídica"));
            }
    ...
    public void atualizar(String nomeStr, String emailStr, String telefoneStr, String cpfStr,
            LocalDate dataNascimentoArg,
            String cnpjStr, String razaoSocialStr, String inscricaoEstadualStr) {
        Set<BeanValidationMessage> violations = new HashSet<>();
