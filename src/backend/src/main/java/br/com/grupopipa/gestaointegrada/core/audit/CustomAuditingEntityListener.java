...
/**
 * Listener customizado de auditoria.
 * Na criação, preenche todos os campos de auditoria.
 * Na atualização, verifica se é soft delete (deleted=true) e preserva updatedBy/updatedAt nesse caso.
 */
