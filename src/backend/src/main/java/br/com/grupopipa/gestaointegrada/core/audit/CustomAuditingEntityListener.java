...
/**
 * Listener customizado de auditoria. Na criação, preenche todos os campos de
 * auditoria. Na
 * atualização, verifica se é soft delete (deleted=true) e preserva
 * updatedBy/updatedAt nesse caso.
 */
public class CustomAuditingEntityListener {
    ...
    public void touchForUpdate(Object target) {
        if (target instanceof BaseEntity) {
            ...
            // Se está sendo feito soft delete (deleted=true), não atualiza
            // updatedBy/updatedAt
