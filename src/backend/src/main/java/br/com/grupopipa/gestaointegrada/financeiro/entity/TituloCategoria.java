...
/**
 * Entidade que representa uma categoria de título financeiro. Permite classificar receitas e
 * despesas com suporte a agrupamento hierárquico.
 *
 * <p>Exemplo de uso: - Agrupador: "DESPESAS OPERACIONAIS" (codigo: "001") - Categoria: "Material de
 * Escritório" (codigo: "001.001") - Categoria: "Material de Limpeza" (codigo: "001.002")
 *
 * <p>- Agrupador: "RECEITA DE SERVIÇOS" (codigo: "002") - Categoria: "Consultoria" (codigo:
...
public class TituloCategoria extends BaseEntity {
  ...
  @JoinColumn(
      name = "agrupador_id",
      foreignKey = @ForeignKey(name = "fk_titulo_categoria_agrupador"))
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TituloCategoria)) return false;
  ...
  public static class Builder {
    ...
    public TituloCategoria build() {
      ValidatedData data =
          validate(this.codigo, this.nome, this.descricao, this.tipo, this.agrupador);
