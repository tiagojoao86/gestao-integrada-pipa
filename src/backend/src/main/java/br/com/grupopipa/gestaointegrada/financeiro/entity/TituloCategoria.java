...
/**
 * Entidade que representa uma categoria de título financeiro.
 * Permite classificar receitas e despesas com suporte a agrupamento hierárquico.
 *
 * Exemplo de uso:
 * - Agrupador: "DESPESAS OPERACIONAIS" (codigo: "001")
 *   - Categoria: "Material de Escritório" (codigo: "001.001")
 *   - Categoria: "Material de Limpeza" (codigo: "001.002")
 *
 * - Agrupador: "RECEITA DE SERVIÇOS" (codigo: "002")
 *   - Categoria: "Consultoria" (codigo: "002.001")
 *   - Categoria: "Manutenção" (codigo: "002.002")
 */
@Entity
...
public class TituloCategoria extends BaseEntity {
    ...
    private TituloCategoria(String codigo, Nome nome, String descricao, TituloCategoriaTipoEnum tipo, TituloCategoria agrupador) {
        this.codigo = codigo;
        this.nome = nome;
    ...
    private static class ValidatedData {
        ...
        ValidatedData(String codigo, Nome nome, String descricao, TituloCategoriaTipoEnum tipo, TituloCategoria agrupador) {
            this.codigo = codigo;
            this.nome = nome;
            this.descricao = descricao;
            this.tipo = tipo;
    ...
    private static ValidatedData validate(String codigo, String nomeStr, String descricaoStr, TituloCategoriaTipoEnum tipo, TituloCategoria agrupador) {
        ...
        if (agrupador != null && tipo != null && agrupador.getTipo() != tipo) {
            violations.add(new BeanValidationMessage("agrupador",
        ...
        return new ValidatedData(codigo != null ? codigo.trim() : null, nome, descricaoStr, tipo, agrupador);
    }

    public void atualizar(String codigo, String nome, String descricao, TituloCategoriaTipoEnum tipo, TituloCategoria agrupador) {
