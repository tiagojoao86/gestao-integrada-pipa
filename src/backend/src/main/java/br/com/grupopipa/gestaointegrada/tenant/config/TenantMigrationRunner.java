...
/**
 * Executa migrations pendentes em todos os tenants ativos na inicialização do
 * sistema.
 *
 * <p>
 * ⚠️ IMPORTANTE: Quando você adicionar novas migrations em
 * db/tenant-migrations/, este
 * componente garante que TODOS os tenants existentes recebam as atualizações,
 * não apenas os novos
 * tenants criados após a migration.
 *
 * <p>
 * Exemplo de cenário: 1. Sistema tem tenants: empresa_lunar, empresa_solar 2.
 * Você adiciona
 * V20251201000000__adiciona_coluna_email.sql 3. Na próxima inicialização, esta
...
public class TenantMigrationRunner {
    ...
    /**
     * Executa após a inicialização completa do Spring Boot. Usa
     * ApplicationReadyEvent para garantir
