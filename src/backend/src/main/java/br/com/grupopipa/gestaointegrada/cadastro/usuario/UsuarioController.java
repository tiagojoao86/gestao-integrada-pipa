...
public class UsuarioController extends BaseController<UsuarioDTO, UsuarioGridDTO, UsuarioService> {
  ...
  /**
   * Endpoint para buscar perfis disponíveis para vinculação com usuários. Retorna lista completa
   * sem paginação, ideal para autocomplete.
   */
  ...
  /**
   * Endpoint para buscar unidades de negócio ativas disponíveis para vinculação com usuários.
   * Retorna lista completa sem paginação, incluindo TODAS as unidades (sem filtro por usuário).
   */
