 ...
 * busca o nome da constraint neste enum e retorna a userMessageKey correspondente
 * para que o frontend exiba uma mensagem traduzida ao usuário.
 *
...
public enum DatabaseConstraintsEnum {
    ...
    /**
     * Busca a constraint pelo nome (case-insensitive).
