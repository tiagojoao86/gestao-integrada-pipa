...
/**
 * Enum que mapeia nomes de constraints do banco de dados para chaves de mensagem i18n.
 *
 * <p>Quando uma constraint é violada, o RestExceptionHandler captura a exceção, busca o nome da
 * constraint neste enum e retorna a userMessageKey correspondente para que o frontend exiba uma
 * mensagem traduzida ao usuário.
 *
 * <p>IMPORTANTE: Sempre que criar uma constraint na migration, adicione-a aqui!
 */
public enum DatabaseConstraintsEnum {
  ...
  /**
   * Busca a constraint pelo nome (case-insensitive). Retorna DEFAULT se não encontrar.
   *
