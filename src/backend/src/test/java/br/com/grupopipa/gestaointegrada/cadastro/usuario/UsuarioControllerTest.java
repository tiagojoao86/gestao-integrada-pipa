...
/**
 * Testes unitários para UsuarioController. Usa MockMvc para testar os endpoints REST sem subir o
...
class UsuarioControllerTest {
  ...
  void deveCriarNovoUsuario() throws Exception {
    // Given
    UsuarioDTO novoDTO =
        UsuarioDTO.builder().nome("Maria Santos").login("maria.santos").senha("senha123").build();
