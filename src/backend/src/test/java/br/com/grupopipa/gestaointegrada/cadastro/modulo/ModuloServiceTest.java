...
/**
 * Testes unitários para ModuloService. Usa Mockito para simular dependências (repository).
 *
...
class ModuloServiceTest {
  ...
  @Mock private ModuloRepository repository;

  @Mock private Specifications<ModuloEntity> specifications;

  @InjectMocks private ModuloServiceImpl service;
