...
/** Testes de integração para PlanoContasController. Valida os endpoints REST do plano de contas. */
@WebMvcTest(
    value = PlanoContasController.class,
...
class PlanoContasControllerTest {
  ...
  @MockitoBean private PlanoContasService service;
