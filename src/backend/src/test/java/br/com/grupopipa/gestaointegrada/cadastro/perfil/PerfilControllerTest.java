...
/**
 * Testes unitários para PerfilController. Usa MockMvc para testar os endpoints
 * REST sem subir o
...
@WebMvcTest(value = PerfilController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = ".*TenantFilter"))
