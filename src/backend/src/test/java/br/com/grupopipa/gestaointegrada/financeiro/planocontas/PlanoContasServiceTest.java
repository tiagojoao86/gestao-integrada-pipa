...
/**
 * Testes unitários para PlanoContasServiceImpl. Valida as regras de negócio do serviço de plano de
 * contas.
 */
...
class PlanoContasServiceTest {
  ...
  @Mock private PlanoContasRepository repository;

  @Mock private UnidadeNegocioRepository unidadeNegocioRepository;

  @Mock private Specifications<PlanoContas> specifications;

  @InjectMocks private PlanoContasServiceImpl service;
  ...
  void deveLancarExcecaoAoCriarComPlanoPaiInexistente() {
    // Given
    UUID planoPaiId = UUID.randomUUID();
    PlanoContasDTO dtoComPaiInvalido =
        PlanoContasDTO.builder()
            .codigo("1.1")
            .descricao("Receitas Operacionais")
            .tipo(TipoPlanoContas.RECEITA.name())
  ...
  void deveCriarPlanoContasDespesaComPlanoPai() {
    ...
    PlanoContasDTO dtoDespesaFilho =
        PlanoContasDTO.builder()
            .codigo("2.1")
