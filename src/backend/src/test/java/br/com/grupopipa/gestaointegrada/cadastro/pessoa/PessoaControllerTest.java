...
/**
 * Testes unitários para PessoaController.
...
@WebMvcTest(value = PessoaController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = ".*TenantFilter"))
...
class PessoaControllerTest {
        ...
        void deveListarPessoas() throws Exception {
                ...
                PessoaGridDTO gridDTO1 = PessoaGridDTO.builder()
                                .id(id)
                                .nome("João da Silva")
                ...
                PessoaGridDTO gridDTO2 = PessoaGridDTO.builder()
                                .id(UUID.randomUUID())
                                .nome("Empresa XYZ Ltda")
                ...
                PageDTO<PessoaGridDTO> pageDTO = new PageDTO<>(
                                List.of(gridDTO1, gridDTO2),
                                PageRequest.of(0, 10),
                                2L);
                ...
                // When & Then
                mockMvc.perform(post("/pessoa/query")
                                .with(csrf())
        ...
        void deveCriarNovaPessoaFisica() throws Exception {
                // Given
                PessoaDTO novaPessoa = PessoaDTO.builder()
                                .tipoPessoa("FISICA")
                                .nome("Maria Santos")
                                .cpf("98765432100")
        ...
        void deveBuscarPessoaPorId() throws Exception {
                ...
                // When & Then
                mockMvc.perform(get("/pessoa/find-by-id")
