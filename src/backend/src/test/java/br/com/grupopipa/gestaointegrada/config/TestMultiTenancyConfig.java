 ...
 * 
 * Define o tenant padrão como 'teste_tenant' para todos os testes,
 * garantindo isolamento e consistência com o ambiente de produção.
 */
@TestConfiguration
@Profile("test")
public class TestMultiTenancyConfig {
    ...
    /**
     * Configura o TenantContext sempre que o contexto Spring é carregado ou recarregado.
     * Isso é crucial para testes com @DirtiesContext, pois o contexto é recriado.
     */
    @EventListener
    public void onContextRefreshed(ContextRefreshedEvent event) {
        TenantContext.setTenantId(TEST_TENANT_SCHEMA);
        System.out.println("🔧 TenantContext configurado após refresh do contexto: " + TEST_TENANT_SCHEMA);
    }
