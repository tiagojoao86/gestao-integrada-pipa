 ...
 *
 * <p>Define o tenant padrão como 'teste_tenant' para todos os testes, garantindo isolamento e
...
public class TestMultiTenancyConfig {
  ...
  /**
   * Configura o TenantContext sempre que o contexto Spring é carregado ou recarregado. Isso é
