...
class SetorServiceTest {
  ...
  @Mock private SetorRepository repository;

  @Mock private CentroCustoRepository centroCustoRepository;

  @Mock private Specifications<Setor> specifications;

  @InjectMocks private SetorServiceImpl service;
  ...
  void deveLancarExcecaoQuandoCentroCustoNaoExiste() {
    ...
    SetorDTO dtoInvalido =
        SetorDTO.builder().nome("Setor Teste").centroCustoId(centroCustoInexistente).build();
