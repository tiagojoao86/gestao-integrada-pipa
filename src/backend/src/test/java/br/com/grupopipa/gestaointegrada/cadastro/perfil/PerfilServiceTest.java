...
/** Testes unitários para PerfilService. Usa Mockito para simular dependências (repository). */
@DisplayName("PerfilService - Testes Unitários")
@ExtendWith(MockitoExtension.class)
class PerfilServiceTest {

  @Mock private PerfilRepository repository;

  @Mock private Specifications<PerfilEntity> specifications;

  @Mock private ModuloRepository moduloRepository;

  @Mock private PerfilModuloRepository perfilModuloRepository;

  @InjectMocks private PerfilServiceImpl service;
