 ...
 *
 * <p>
 * Cria o schema 'teste_tenant' e executa todas as migrations de tenant nele,
 * simulando o
 * ambiente real de produção.
 *
 * <p>
 * IMPORTANTE: Usa flag estática para garantir que a inicialização ocorra apenas
 * uma vez por
...
public class TestTenantInitializer {
    ...
    /**
     * Bean que inicializa o tenant de teste. Flyway é idempotente, então não há
     * problema em chamar
     * múltiplas vezes.
     */
    @Bean
