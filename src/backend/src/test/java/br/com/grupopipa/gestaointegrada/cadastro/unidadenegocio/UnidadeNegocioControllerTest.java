...
/**
 * Testes unitários para UnidadeNegocioController. Usa MockMvc para testar os
 * endpoints REST sem
 * subir o servidor. Usa @MockitoBean para simular o
 * service. @AutoConfigureMockMvc(addFilters =
 * false) desabilita os filtros de segurança, permitindo testar apenas a lógica
 * do controller
...
@WebMvcTest(value = UnidadeNegocioController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = ".*TenantFilter"))
...
class UnidadeNegocioControllerTest {
    ...
    void deveListarUnidadesDeNegocio() throws Exception {
        ...
        PageDTO<UnidadeNegocioGridDTO> pageDTO = new PageDTO<>(List.of(gridDTO), PageRequest.of(0, 10), 1L);
