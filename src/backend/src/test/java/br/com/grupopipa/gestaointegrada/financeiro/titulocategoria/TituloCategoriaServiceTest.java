...
class TituloCategoriaServiceTest {
  ...
  @Mock private TituloCategoriaRepository repository;

  @Mock private Specifications<TituloCategoria> specifications;

  @InjectMocks private TituloCategoriaServiceImpl service;
  ...
  void deveCriarCategoriaComAgrupador() {
    ...
    TituloCategoriaDTO dtoComAgrupador =
        TituloCategoriaDTO.builder()
            .codigo("001.001")
    ...
    TituloCategoria entityComAgrupador =
        new TituloCategoria.Builder()
            .codigo("001.001")
            .nome("Material de Escritório")
            .descricao("Sub-categoria")
  ...
  void deveConstruirDTOComAgrupadorDaEntidade() {
    ...
    TituloCategoria categoriaComAgrupador =
        new TituloCategoria.Builder()
            .codigo("002.001")
            .nome("Consultoria")
  ...
  void deveLancarExcecaoAoBuscarAgrupadorInexistente() {
    TituloCategoriaDTO dtoComAgrupadorInvalido =
        TituloCategoriaDTO.builder()
            .codigo("003.001")
            .nome("Categoria Teste")
            .descricao("Descrição")
