...
/**
 * Testes unitários para MovimentacaoFinanceiraController. Valida os endpoints
 * REST da API de
...
class MovimentacaoFinanceiraControllerTest {
    ...
    void deveListarMovimentacoesPaginadas() throws Exception {
        ...
        MovimentacaoFinanceiraGridDTO gridDTO = MovimentacaoFinanceiraGridDTO.builder()
                .id(movimentacaoId)
                .tipo(TipoMovimentacao.PAGAMENTO.name())
                .formaPagamento(FormaPagamento.PIX.name())
                .valor(BigDecimal.valueOf(500.00))
        ...
        PageDTO<MovimentacaoFinanceiraGridDTO> pageDTO = new PageDTO<>(List.of(gridDTO), PageRequest.of(0, 10), 1L);
