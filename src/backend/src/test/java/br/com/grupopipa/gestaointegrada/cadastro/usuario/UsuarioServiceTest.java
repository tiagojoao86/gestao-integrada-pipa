...
/**
 * Testes unitários para UsuarioService. Usa Mockito para simular dependências (repository, password
 * encoder).
 */
...
class UsuarioServiceTest {
  ...
  @Mock private Specifications<UsuarioEntity> specifications;
  ...
  void deveCriarNovoUsuarioComPerfis() {
    ...
    // passwordEncoder.encode() é chamado 2 vezes: uma no Builder e outra no construtor de Senha
