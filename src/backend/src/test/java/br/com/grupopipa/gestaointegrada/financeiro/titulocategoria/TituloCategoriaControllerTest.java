...
@WebMvcTest(
    value = TituloCategoriaController.class,
...
class TituloCategoriaControllerTest {
  ...
  @MockitoBean private TituloCategoriaService service;
  ...
  void setup() {
    ...
    gridDTO =
        TituloCategoriaGridDTO.builder()
            .id(categoriaId)
            .nome("Categoria Teste")
            .descricao("Descrição")
            .build();
  ...
  void deveListarCategoriasPaginadas() throws Exception {
    ...
    PageDTO<TituloCategoriaGridDTO> pageDTO =
