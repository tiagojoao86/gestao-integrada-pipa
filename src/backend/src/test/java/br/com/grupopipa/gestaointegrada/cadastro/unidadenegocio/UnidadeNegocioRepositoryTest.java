...
class UnidadeNegocioRepositoryTest extends AbstractIntegrationTest {
  ...
  @Autowired private UnidadeNegocioRepository repository;
  ...
  void deveValidarCodigoUnico() {
    ...
    UnidadeNegocio unidade1 =
        new UnidadeNegocio.Builder().codigo("UN002").nome("Unidade 1").build();
    repository.save(unidade1);

    UnidadeNegocio unidade2 =
        new UnidadeNegocio.Builder().codigo("UN002").nome("Unidade 2").build(); // Mesmo código
  ...
  void deveFiltrarUnidadesAtivasEInativas() {
    ...
    var apenasAtivas = todasUnidades.stream().filter(UnidadeNegocio::isAtiva).toList();
  ...
  void deveDeletarUnidadeNegocio() {
    // Given
    UnidadeNegocio unidade =
        new UnidadeNegocio.Builder().codigo("UN006").nome("Unidade para Deletar").build();
    UnidadeNegocio salva = repository.save(unidade);
  ...
  void deveAtualizarCNPJDeUnidadeNegocio() {
    ...
    // When
    salva.atualizar("Unidade Para Atualizar CNPJ", "Descrição", "34.028.316/0001-03");
    UnidadeNegocio atualizada = repository.save(salva);
