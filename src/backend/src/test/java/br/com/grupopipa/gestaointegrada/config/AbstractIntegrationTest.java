 ...
 *
 * <p>
 * Esta classe configura: - Container PostgreSQL reutilizável - Tenant de teste
 * 'teste_tenant'
 * com todas as migrations - Multi-tenancy configurado para usar o tenant de
 * teste - Security
...
public abstract class AbstractIntegrationTest {
    ...
    /**
     * Container PostgreSQL compartilhado entre todos os testes. O container é
     * iniciado manualmente no
     * bloco static e fica ativo durante toda a execução da suite de testes. Não
     * usamos @Container
     * aqui porque queremos controlar manualmente o ciclo de vida do container para
     * evitar que ele
    ...
    /**
     * Garante que o TenantContext seja configurado antes de cada teste. Isso é
     * crucial para testes
     * com @DirtiesContext, pois o contexto é recriado e o TenantContext precisa ser
     * redefinido.
     */
    @BeforeEach
    ...
    /**
     * Configura as propriedades do Spring dinamicamente com base nas configurações
     * do container
     * PostgreSQL.
     */
