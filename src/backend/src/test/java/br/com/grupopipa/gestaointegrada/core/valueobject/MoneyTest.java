...
class MoneyTest {
    ...
    void deveRejeitarMoneyNulo() {
        assertThrows(BeanValidationException.class, () -> new Money((BigDecimal) null));
    }
    ...
    void deveVerificarSeEhPositivo() {
        Money positivo = new Money(new BigDecimal("100.00"));
        Money negativo = new Money(new BigDecimal("-50.00"));
    ...
    void deveManterImutabilidadeEmOperacoes() {
        ...
        Money outro = new Money(new BigDecimal("50.00"));
