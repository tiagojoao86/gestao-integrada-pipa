...
/** Testes unitários para PessoaService. Usa Mockito para simular dependências (repository). */
...
class PessoaServiceTest {
  ...
  @Mock private Specifications<Pessoa> specifications;

  @InjectMocks private PessoaServiceImpl service;
  ...
  void deveLancarExcecaoParaTipoPessoaInvalido() {
    // Given
    PessoaDTO dtoInvalido = PessoaDTO.builder().tipoPessoa("INVALIDO").nome("Teste").build();

    // When & Then
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> service.save(dtoInvalido));
